...
function speakBodyContent(language) {
    if (currentSpeech !== null && window.speechSynthesis.speaking) {
        // If speech is currently in progress, stop it
        ...
        speech.text = bodyText;
        speech.lang = language || 'en'; // Set language to English by default
        currentSpeech = speech; // Update current speech
...
function resumeSpeech() {
    if (currentSpeech !== null && window.speechSynthesis.paused) {
